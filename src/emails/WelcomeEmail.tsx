...
const WelcomeEmail = ({
	...
	return (
		<Html>
			<Head />
			<Preview>Welcome to FansSecret!</Preview>
			<Body style={main}>
				<Container style={container}>
					<Section style={message}>
						<Img
							src={`${BASE_URL}/fansSecret-logo.jpeg`}
							width='600'
							height='400'
							alt='welcome icon'
							style={{ margin: "auto", borderRadius: 10 }}
						/>
						<Heading style={{ ...global.heading }}>Welcome to FansSecret!</Heading>
					...
					<Section style={global.defaultPadding}>
						<Text style={footer.text}>
							© {new Date().getFullYear()} FansSecret, Inc. All Rights Reserved.
						</Text>
					</Section>
				</Container>
			</Body>
