...
const ExistingProducts = () => {
	...
	return (
		<>
			<p className='text-3xl tracking-tighter my-3 font-medium'>Existing Content</p>
			...
			{!isLoading && products?.length === 0 && (
				<div className='flex flex-col items-center justify-center mt-10 p-6 bg-secondary rounded-lg shadow-md'>
					...
					<p className='text-center text-xl text-red-600 font-semibold mt-4'>No content found</p>
